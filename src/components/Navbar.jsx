...
const Navbar = () => {
  ...
  const handleHireMeClick = () => {
    navigate("/ContactInfoCard"); // Navigate to your "Hire Me" page or component
  };

  return (
    <nav className="container sticky z-10 mx-auto top-5">
      <div className="flex items-center justify-between rounded-full bg-white/25 border border-[#00a6fb] backdrop-blur-[10px] m-5 p-3 md:p-0">
        {/* Logo */}
        <img className="ml-6 -mb-1 h-7" src={LOGO} alt="Logo" />
